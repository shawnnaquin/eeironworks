	...
	<div class="sui-dialog-content" aria-labelledby="switchAdvanced" aria-describedby="dialogDescription" role="dialog">
		...
		<div class="sui-box" role="document">
			...
			<div class="sui-box-header">
				<h3 class="sui-box-title" id="switchAdvanced"><?php esc_html_e( 'Just be careful!', 'wphb' ); ?></h3>
			...
			<div class="sui-box-body">
				...
				<div class="wphb-block-content-center">
					<a onclick="WPHB_Admin.minification.switchView( 'advanced' )"  class="sui-button"><?php esc_html_e( 'Got It', 'wphb' ); ?></a>
				</div>
			</div>

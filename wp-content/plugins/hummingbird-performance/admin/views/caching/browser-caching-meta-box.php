...
<div class="wphb-border-frame">
	...
	foreach ( $human_results as $type => $result ) :
		...
		<div class="table-row">
			...
			<div class="wphb-caching-summary-item-expiry">
				<span class="wphb-button-label wphb-button-label-light sui-tooltip sui-tooltip-constrained" data-tooltip="<?php echo esc_attr( $expiry_tooltip ); ?>">
					<?php echo esc_html( $recommended[ $type ]['label'] ); ?>
				</span>
			</div>
			<div class="wphb-caching-summary-item-status">
				<span class="wphb-button-label wphb-button-label-<?php echo esc_attr( $status_color ); ?>  sui-tooltip sui-tooltip-constrained" data-tooltip="<?php echo esc_attr( $status_tooltip ); ?>">
	...
	if ( $cf_active ) : ?>
		<div class="table-row">
			...
			<div class="wphb-caching-summary-item-expiry">
				<span class="wphb-button-label wphb-button-label-light sui-tooltip sui-tooltip-constrained" data-tooltip="<?php echo esc_attr( $cf_tooltip ); ?>">
					<?php echo esc_html( $cf_recommended ); ?>
				</span>
			</div>
			<div class="wphb-caching-summary-item-status">
				<span class="wphb-button-label wphb-button-label-<?php echo esc_attr( $cf_status_color ); ?> sui-tooltip sui-tooltip-constrained" data-tooltip="<?php echo esc_attr( $cf_status_tooltip ); ?>">

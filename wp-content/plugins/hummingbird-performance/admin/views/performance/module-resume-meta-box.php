...
<div class="sui-summary-segment">
	<div class="sui-summary-details">
		...
		if ( $last_report && ! is_wp_error( $last_report ) && ! $report_dismissed ) :
			$error_class = ( 'aplus' === $last_report->score_class || 'a' === $last_report->score_class || 'b' === $last_report->score_class ) ? 'success' : 'warning';
			$icon_class = ( 'aplus' === $last_report->score_class || 'a' === $last_report->score_class || 'b' === $last_report->score_class ) ? 'check-tick' : 'info';
			?>
